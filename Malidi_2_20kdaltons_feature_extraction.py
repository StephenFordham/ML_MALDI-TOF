...
def _epilog():
    return ("\nHow to run? It's easy, just follow the terminal examples listed"
            "\npython Malidi_2_20kdaltons_feature_extraction.py --folder directory_with_raw_maldi_csv_files"
            "\npython Malidi_2_20kdaltons_feature_extraction.py -f directory_with_raw_maldi_csv_files"
            "\npython Malidi_2_20kdaltons_feature_extraction.py -f directory -o maldi_output")
